...
user in an INI file next to MultiBitPortable.exe called MultiBitPortable.ini.
...
copy AppNamePortable.ini from this directory to MultiBitPortable.ini next to
MultiBitPortable.exe. The options in the INI file are as follows:
